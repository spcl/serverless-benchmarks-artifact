...
RuntimeError: First invocation not cold on time 360 rep 0 pid 8 tid 0
"""
...
Traceback (most recent call last):
  ...
  File "/usr/lib64/python3.6/multiprocessing/pool.py", line 644, in get
    raise self._value
RuntimeError: First invocation not cold on time 360 rep 0 pid 8 tid 0
slurmstepd: error: Unable to unlink domain socket `/tmp/slurmd/ault10_25871.4294967294`: No such file or directory
