...
RuntimeError: First invocation not cold on time 1080 rep 0 pid 1 tid 5
"""
...
Traceback (most recent call last):
  ...
  File "/users2/mcopik/projects/serverless-benchmarks/serverless-benchmarks/scripts/CloudExperiments.py", line 244, in __init__
    ret = result.get()
  File "/usr/lib64/python3.6/multiprocessing/pool.py", line 644, in get
    raise self._value
RuntimeError: First invocation not cold on time 1080 rep 0 pid 1 tid 5
